...
public class ServerInfo
{
    ...
    [JsonPropertyName("__rowId")] public string RowId { get; set; }

    [JsonPropertyName("host")] public string Host { get; set; }

    [JsonPropertyName("clanonly")] public bool ClanOnly { get; set; }

    [JsonPropertyName("platform")] public int Platform { get; set; }

    [JsonPropertyName("mods")] public bool Mods { get; set; }
    ...
    [JsonPropertyName("fo")] public bool Fo { get; set; }

    [JsonPropertyName("password")] public bool Password { get; set; }

    [JsonPropertyName("guid")] public string Guid { get; set; }

    [JsonPropertyName("maxconnections")] public int MaxConnections { get; set; }

    [JsonPropertyName("dedicated")] public bool Dedicated { get; set; }

    [JsonPropertyName("clienthosted")] public bool ClientHosted { get; set; }
    ...
    [JsonPropertyName("lanonly")] public bool LanOnly { get; set; }

    [JsonPropertyName("intent")] public string Intent { get; set; }

    [JsonPropertyName("allownewplayers")] public bool AllowNewPlayers { get; set; }

    [JsonPropertyName("serverpaused")] public bool ServerPaused { get; set; }

    [JsonPropertyName("steamid")] public string SteamId { get; set; }

    [JsonPropertyName("steamroom")] public string SteamRoom { get; set; }

    [JsonPropertyName("secondaries")] public Dictionary<string, SecondaryInfo> Secondaries { get; set; }

    [JsonPropertyName("data")] public string Data { get; set; }

    [JsonPropertyName("worldgen")] public string WorldGen { get; set; }

    [JsonPropertyName("players")] public string Players { get; set; }

    [JsonPropertyName("mods_info")] public List<object> ModsInfo { get; set; }

    [JsonPropertyName("tick")] public int Tick { get; set; }

    [JsonPropertyName("clientmodsoff")] public bool ClientModsOff { get; set; }

    [JsonPropertyName("nat")] public int Nat { get; set; }

    public List<Player> GetPlayers()
    {
        var players = new List<Player>();
        var pattern =
            @"colour=""(?<colour>[A-Z0-9]+)"".*?eventlevel=(?<eventlevel>\d+).*?name=""(?<name>.*?)"".*?netid=""(?<netid>\d+)"".*?prefab=""(?<prefab>\w+)""";
